    ...
    <div class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
            <h1 class="text-4xl font-bold text-gray-900 mb-4">
                About Genchess Academy
            </h1>
            <p class="text-lg text-gray-700">
                At Genchess Academy, we believe chess is more than a game.
        ...
        <img 
            ...
            alt="Genchess Academy chess training session"
    ...
    <div class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            ...
            <p class="text-gray-700 leading-relaxed">
                Genchess Academy is an educational chess organization focused on
...
<section class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-6 py-16 text-center">
        ...
        <p class="max-w-3xl mx-auto text-lg text-gray-300">
            ...
            At Genchess Academy, we use chess to prepare children not just for competitions,
